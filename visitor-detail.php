...
$remark=$_POST['remark'];
 $query=mysqli_query($con,"update tblvisitor set remark='$remark' where  ID='$eid'");
    ...
    if ($query) {
    $msg="Detalles del visitante han sido actualizados";
  }
  else
    {
...
<body class="animsition">
    <div class="page-wrapper">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Detalles</strong> del visitante
                                    </div>
     ...
     echo "Swal.fire(
         'Listo!',
         'se han actualizado los datos del registro',
         'success'
     )";
     echo "</script>";
  }  ?> </p>
...
<?php if($row['remark']==""){ ?>
 ...
 <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-primary btn-sm">Actualizar</button></td>
  </tr>
                                        </form>
               <?php } else { ?>
