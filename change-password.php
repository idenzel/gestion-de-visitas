                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Cambio</strong> de contraseña de administrador
                                    </div>
...
?>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Contraseña actual</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Confirma contraseña</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                        ...
                                        <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-primary btn-sm">Cambiar contraseña
                                        </button></p>
